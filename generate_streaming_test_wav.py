...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_audio_file',
        type=str,
        default='/home/zoutai/DataSets/speech_data/speech_commands_train/streaming_test.wav',
        help='File to save the generated test audio to.')
    parser.add_argument(
        '--output_labels_file',
        type=str,
        default='/home/zoutai/DataSets/speech_data/speech_commands_train/streaming_test_labels.txt',
