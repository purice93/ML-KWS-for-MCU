...
--checkpoint=/home/zoutai/ML_KWS/speech_commands_train/conv.ckpt-1300 \
--output_file=/home/zoutai/ML_KWS/my_frozen_graph.pb
...
def create_inference_graph(wanted_words, sample_rate, clip_duration_ms,
    ...
    spectrogram = contrib_audio.audio_spectrogram(
        ...
        magnitude_squared=True,name='spectrogram')
    fingerprint_input = contrib_audio.mfcc(
        spectrogram,
        decoded_sample_data.sample_rate,
        dct_coefficient_count=dct_coefficient_count,name='fingerprint_input')
